...
#define PECI_MBX_INDEX_CONSTRAINED_TIME                                        \
  32                                        /* Thermally Constrained Time Read \
                                             */
...
#define PECI_MBX_INDEX_DDR_HOT_ABSOLUTE                                        \
  43 /* DDR Hottest Dimm Absolute Temp                                         \
      */
#define PECI_MBX_INDEX_DDR_HOT_RELATIVE                                        \
  44                                        /* DDR Hottest Dimm Relative Temp  \
                                             */
#define PECI_MBX_INDEX_DDR_THROTTLE_TIME 45 /* DDR Throttle Time */
#define PECI_MBX_INDEX_DDR_THERM_STATUS 46  /* DDR Thermal Status */
#define PECI_MBX_INDEX_TIME_AVG_TEMP                                           \
  47 /* Package time-averaged temperature                                      \
      */
...
#define PECI_IOC_CRASHDUMP_DISC                                                \
  _IOWR(PECI_IOC_BASE, PECI_CMD_CRASHDUMP_DISC, struct peci_crashdump_disc_msg)
